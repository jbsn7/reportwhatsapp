...
{blue}{!}{red} By insta id 😉 ravi_jbsn
...
mail = input(f'''{red}┌─[{green} reportwhatsapp{blue}~{white}@YOUR-EMAIL{red}]

└──╼{white} 卍 ''')

passwd = input(f'''{red}┌─[{green} reportwhatsapp{blue}~{white}@PASSWORD{red}]

└──╼{white} 卍 ''')

target = input(f'''{red}┌─[{green} reportwhatsapp{blue}~{white}@TARGET-NUMBER{red}]

└──╼{white} 卍 ''')

count = input(f'''{red}┌─[{green} reportwhatsapp{blue}~{white}@REPORT-COUNT{red}]
...
report_type = input(f'''{red}┌─[{green} reportwhatsapp{blue}~{white}@REPORT-TYPE{red}]
...
try:
    ...
    with smtplib.SMTP(host='smtp.gmail.com', port=587) as smtp:
        ...
        for i in range(1,int(count)+1):
            ...
            print(f'{cyan}[{Current_time}] {white} reportwhatsapp Report Result : {green}True')
    ...
    print(f'{cyan}[{Current_time}] {white} reportwhatsapp Report Result : {red}False')
